...
%                 axis( [ 0 2*lp+lt+40 zd-2 Zall(1)+2 ] );
        ...
        x = 20 : Tf;
        figure ( 1 )
        plot ( x / 60 * Dt , H1 ( 20 : Tf ) - H1 ( 20 ), x / 60 * Dt , H2 ( 20 : Tf ) - H2 ( 20 ) )
        legend({'管道前水位变化值','管道后水位变化值'},'FontSize',14);
        ylabel ( '水位(m)','FontSize',14) ; xlabel('时间（h)','FontSize',14) 
        figure ( 2 )
        subplot(1,2,1)
        plot ( x / 60 * Dt , H3 ( 20 : Tf ), '+', x / 60 * Dt , H2 ( 20 : Tf ) )
        ylabel ( '水位(m)','FontSize',14) ; xlabel('时间（h)','FontSize',14) ;
        legend({'H1-hf','H2'},'FontSize',14);
        subplot(1,2,2)
        plot ( x / 60 * Dt , H4 ( 20 : Tf ), '+', x / 60 * Dt , H2 ( 20 : Tf ) )
        ylabel ( '水位(m)','FontSize',14) ; xlabel('时间（h)','FontSize',14) ;
        legend({'H1-hf-hi','H2'},'FontSize',14);
%         figure ( 3 )
