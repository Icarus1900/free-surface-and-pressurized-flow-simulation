...
while norm ( ZQ1 - ZQ2 ) > Emax||temp <= 1                              %当ZQ1与ZQ2足够相似时停止计算
    ...
    for I = 1 : N - 1                             %计算方格编号
        ...
        elseif I == nl || I == nt + nl
            ...
            c1= R;                                         %R：系数θ
            e1=(1-R)*(Q ( I )-Q ( I + 1 ));
            a2=-2*R*(DT/DS)*G*(pi*Rt^2/4);
            c2=1;
            d2=1;
            e2=-2*DT/DS*G*(pi*Rt^2/4)*(1-R)*(Z ( I + 1 )-Z ( I ))+Q ( I + 1 )+Q ( I )-2*G*(Q ( I ))^2*DT*n2^2/(pi*Rt^2/4)/(Rt/4)^(4/3);
            Aeq(8*I-6,1)=2*I;Aeq(8*I-6,2)=2*I-1;Aeq(8*I-6,3)=0;
            Aeq(8*I-5,1)=2*I;Aeq(8*I-5,2)=2*I;  Aeq(8*I-5,3)=-1*c1;
            Aeq(8*I-4,1)=2*I;Aeq(8*I-4,2)=2*I+1;Aeq(8*I-4,3)=0;
            Aeq(8*I-3,1)=2*I;Aeq(8*I-3,2)=2*I+2;Aeq(8*I-3,3)=c1;
            Beq(2*I)=e1;
            Aeq(8*I-2,1)=2*I+1;Aeq(8*I-2,2)=2*I-1;Aeq(8*I-2,3)=a2;
            Aeq(8*I-1,1)=2*I+1;Aeq(8*I-1,2)=2*I;  Aeq(8*I-1,3)=c2;
